...
typedef enum { CFG_CELSIUS = 1, CFG_BUZZER = 2, CFG_SWITCH = 4, CFG_AU_START = 8,
				CFG_U_CLOCKWISE = 16, CFG_L_CLOCKWISE = 32, CFG_BIG_STEP = 128 } CFG_BIT_MASK;
...
struct s_config {
	...
	uint16_t	jbc_low_temp;						// The T12 IRON low power temperature (C) or 0 if the tilt sensor is disabled
